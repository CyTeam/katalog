...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.item :nav_dossiers, t('katalog.main_navigation.dossiers'), '#' do |dossier|
      dossier.item :index, t('katalog.main_navigation.dossier_index'), dossiers_path, highlights_on: /\/dossiers$/
    ...
    if current_user && (current_user.role?(:editor) || current_user.role?(:admin))
