...
function addSphinxAdministrationBehaviour() {
  var froms = $('.sphinx_admin_from');
  var tos = $('.sphinx_admin_to');

  froms.focusout(function(){
    updateSphinxAdminFrom(this);
  });

  froms.keydown(function(event) {
    if(event.keyCode == 13) {
      updateSphinxAdminFrom(this);
    }
  });

  tos.focusout(function(){
    updateSphinxAdminTo(this);
  });

  tos.keydown(function(event) {
    if(event.keyCode == 13) {
      updateSphinxAdminTo(this);
    }
  });
...
function updateSphinxAdminTo(e) {
...
function updateSphinxAdminFrom(e) {
  $.ajax({
    url: '/sphinx_admins',
    type: 'PUT',
    data: {
